...
def vp_start_gui():
    ...
    top.Scrolledtext_msg
    uArmContralFrm_support.init(root, top)
    top.TB_f1.configure(state = 'disabled')
    uArmContralFrm_support.change_btm_disable()
    

    top.TLabel_state.configure(text = "请按连接键，连接设备！")
    root.mainloop()
    w = None
...
class uArm_Contral():
    def __init__(self, top=None):
        ...
        self.TFm_msg.configure(relief=GROOVE)
        self.TFm_msg.configure(width=500)
        ...
        self.TCbox_shake_angle.place(relx=0.02, rely=0.53, relheight=0.35
                , relwidth=0.23)
        ...
        self.TCbox_shake_angle.current(0)

        self.TCbbox_push = ttk.Combobox(self.TFm_set)
        self.TCbbox_push.place(relx=0.48, rely=0.13, relheight=0.35
                , relwidth=0.15)
        ...
        self.TCbbox_push.current(0)

        self.TCbox_pull = ttk.Combobox(self.TFm_set)
        self.TCbox_pull.place(relx=0.48, rely=0.53, relheight=0.35
                , relwidth=0.15)
        ...
        self.TCbox_pull.current(0)

        self.TCbox_up = ttk.Combobox(self.TFm_set)
        self.TCbox_up.place(relx=0.84, rely=0.13, relheight=0.35, relwidth=0.15)
        ...
        self.TCbox_up.current(0)

        self.TCbox_down = ttk.Combobox(self.TFm_set)
        self.TCbox_down.place(relx=0.84, rely=0.53, relheight=0.35
                , relwidth=0.15)
        ...
        self.TCbox_down.current(0)

        self.TLabel1 = ttk.Label(self.TFm_set)
        self.TLabel1.place(relx=0.02, rely=0.13, height=21)
        self.TLabel1.configure(background="#d9d9d9")
        self.TLabel1.configure(foreground="#000000")
        self.TLabel1.configure(relief=FLAT)
        self.TLabel1.configure(takefocus="0")
        self.TLabel1.configure(text="摇动角度：")

        self.TLabel2 = ttk.Label(self.TFm_set)
        self.TLabel2.place(relx=0.30, rely=0.13, height=21)
        self.TLabel2.configure(background="#d9d9d9")
        self.TLabel2.configure(foreground="#000000")
        self.TLabel2.configure(relief=FLAT)
        self.TLabel2.configure(takefocus="0")
        self.TLabel2.configure(text="推距离：")

        self.TLabel3 = ttk.Label(self.TFm_set)
        self.TLabel3.place(relx=0.30, rely=0.53, height=21)
        self.TLabel3.configure(background="#d9d9d9")
        self.TLabel3.configure(foreground="#000000")
        self.TLabel3.configure(relief=FLAT)
        self.TLabel3.configure(takefocus="0")
        self.TLabel3.configure(text='''拉距离:''')

        self.TLabel4 = ttk.Label(self.TFm_set)
        self.TLabel4.place(relx=0.65, rely=0.13, height=21)
        self.TLabel4.configure(background="#d9d9d9")
        self.TLabel4.configure(foreground="#000000")
        self.TLabel4.configure(relief=FLAT)
        self.TLabel4.configure(takefocus="0")
        self.TLabel4.configure(text='''升高度:''')

        self.TLabel5 = ttk.Label(self.TFm_set)
        self.TLabel5.place(relx=0.65, rely=0.53, height=21)
        self.TLabel5.configure(background="#d9d9d9")
        self.TLabel5.configure(foreground="#000000")
        self.TLabel5.configure(relief=FLAT)
        self.TLabel5.configure(takefocus="0")
        self.TLabel5.configure(text='''降高度:''')

        self.TB_com = ttk.Button(self.TFm_top)
        self.TB_com.place(relx=0.89, rely=0.07, height=70, width=50)
        self.TB_com.configure(takefocus="")
        self.TB_com.configure(text='''连接''')
        self.TB_com.configure(width=50)
        self.TB_com.configure(command = uArmContralFrm_support.TB_com_key)
        ...
        self.TB_push.configure(text='''推''')
        self.TB_push.configure(command = uArmContralFrm_support.TB_push_key)
        ...
        self.TB_reset.configure(text='''返回''')
        self.TB_reset.configure(command = uArmContralFrm_support.TB_reset_key)
        ...
        self.TB_pull.configure(text='''拉''')
        self.TB_pull.configure(command = uArmContralFrm_support.TB_pull_key)
        ...
        self.TB_shake_left.configure(text='''左摇''')
        self.TB_shake_left.configure(command = uArmContralFrm_support.TB_shake_left_key)
        ...
        self.TB_shake_right.configure(text='''右摇''')
        self.TB_shake_right.configure(state = 'disabled')
        self.TB_shake_right.configure(command = uArmContralFrm_support.TB_shake_right)
        ...
        self.TB_up.configure(text='''升''')
        self.TB_up.configure(command = uArmContralFrm_support.TB_up_key)
        ...
        self.TB_down.configure(text='''降''')
        self.TB_down.configure(command = uArmContralFrm_support.TB_down_key)
        ...
        self.TB_look_left.configure(text='''左看''')
        self.TB_look_left.configure(command = uArmContralFrm_support.TB_look_left)
        ...
        self.TB_look_center.configure(text='''前看''')
        self.TB_look_center.configure(command = uArmContralFrm_support.TB_look_center)
        ...
        self.TB_look_right.configure(text='''右看''')
        self.TB_look_right.configure(command = uArmContralFrm_support.TB_look_right)
        ...
        self.TB_f1.place(relx=0.02, rely=0.09, height=60, width=90)
        self.TB_f1.configure(takefocus="")
        self.TB_f1.configure(text='''F 1''')
        self.TB_f1.configure(command = uArmContralFrm_support.TB_f1_key)

        self.TB_f2 = ttk.Button(self.TFm_funkey)
        self.TB_f2.place(relx=0.21, rely=0.09, height=60, width=90)
        self.TB_f2.configure(takefocus="")
        self.TB_f2.configure(text='''F 2''')
        self.TB_f2.configure(command = uArmContralFrm_support.TB_f2_key)

        self.TB_f3 = ttk.Button(self.TFm_funkey)
        self.TB_f3.place(relx=0.4, rely=0.09, height=60, width=90)
        self.TB_f3.configure(takefocus="")
        self.TB_f3.configure(text='''F 3''')
        self.TB_f3.configure(command = uArmContralFrm_support.TB_f3_key)

        self.TB_f4 = ttk.Button(self.TFm_funkey)
        self.TB_f4.place(relx=0.6, rely=0.09, height=60, width=90)
        self.TB_f4.configure(takefocus="")
        self.TB_f4.configure(text='''F 4''')
        self.TB_f4.configure(command = uArmContralFrm_support.TB_f4_key)

        self.TB_f5 = ttk.Button(self.TFm_funkey)
        self.TB_f5.place(relx=0.79, rely=0.09, height=60, width=90)
        self.TB_f5.configure(takefocus="")
        self.TB_f5.configure(text='''F 5''')
        self.TB_f5.configure(command = uArmContralFrm_support.TB_f5_key)
